...
echo "Running n_queens_threads from size 5 up to size $max_n..."
echo "Results will be saved to output3.txt"
...
for n in $(seq 5 $max_n); do
    # Run the n_queens_threads program with time command and append the output to a file
    {
        echo ""
        echo "======================================================="
        echo "Running n_queens_threads with board size $n:"
        echo "======================================================="
        # The 'time' command's output goes to stderr, so we redirect it to stdout
        { time ./n_queens_threads $n; } 2>&1
        echo "======================================================="
...
echo "All executions completed. Results saved to output3.txt"
